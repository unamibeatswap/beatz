(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[857],{408:()=>{},455:(e,t,r)=>{"use strict";r.r(t),r.d(t,{client:()=>l,fetchSanity:()=>u,getNavigation:()=>d,getPageBySlug:()=>p,getSiteSettings:()=>o,urlFor:()=>n});var a=r(1940),i=r(2829),s=r.n(i);let l=(0,a.createClient)({projectId:"i01qs9p6",dataset:"production",apiVersion:"2023-05-03",token:"skjFJmUQgJ1AirscHu0KYrF7D5v9ycvCaC94ql0oSKGmqmP4XTFQSTYE02reGAaE8MjAEFWO0ULyzMMMdZVsru3DxUZu7NVaarTpbuArReIpwYAHui66uYPOrNi7ZU26t7dVReebx0OfiHHz3HSMGLHMCviGo2zkcd1Ob5xLRqcNcLdofcXy",useCdn:!0}),c=s()(l);function n(e){return c.image(e)}async function u(e,t={}){try{return await l.fetch(e,t)}catch(e){return null}}async function o(){try{return await l.fetch('*[_type == "siteSettings"][0]')}catch(e){return null}}async function d(e=!0){try{return await l.fetch(`
    ...
    `)}catch(e){return{items:[]}}}async function p(e){try{return await l.fetch(`
      *[_type == "page" && slug.current == $slug][0]
    `,{slug:e})}catch(e){return null}}},6427:(e,t,r)=>{"use strict";r.d(t,{dataProvider:()=>c});var a=r(455);class i{async getProducer(e){try{if(!e)return null;let t=await a.client.fetch(`
        *[_type == "producer" && slug.current == $id][0] {
          _id, name, bio, location, genres, profileImage, coverImage, 
          verified, walletAddress, stats
        }
      `,{id:e});if(!t)return null;return{id:t.slug?.current||t._id,name:t.name||"Beat Creator",bio:t.bio||"",location:t.location||"South Africa",genres:Array.isArray(t.genres)?t.genres:["Hip Hop"],totalBeats:t.stats?.totalBeats||0,totalSales:t.stats?.totalSales||0,verified:t.verified||!1,profileImageUrl:t.profileImage?(0,a.urlFor)(t.profileImage).url():void 0,coverImageUrl:t.coverImage?(0,a.urlFor)(t.coverImage).url():void 0,walletAddress:t.walletAddress||void 0}}catch(e){return null}}async getProducerBeats(e){try{if(!e)return[];let t=await a.client.fetch(`
