...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    const page = await client.fetch(`*[_type == "page" && slug.current == "faq"][0]{seo}`)
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://beatschain.app/faq`,
      type: 'website',
      siteName: 'BeatsChain',
      images: [{
        url: `https://beatschain.app/faq/opengraph-image`,
        width: 1200,
        height: 630,
        alt: title,
      }],
    ...
    twitter: {
      ...
      title,
      description,
      images: [`https://beatschain.app/faq/opengraph-image`],
    },
  }
}
