...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    const page = await client.fetch(`*[_type == "page" && slug.current == "contact"][0]{seo}`)
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://beatschain.app/contact`,
      type: 'website',
      siteName: 'BeatsChain',
      images: [{
        url: `https://beatschain.app/contact/opengraph-image`,
        width: 1200,
        height: 630,
        alt: title,
      }],
    ...
    twitter: {
      ...
      title,
      description,
      images: [`https://beatschain.app/contact/opengraph-image`],
    },
  }
}
