...
export const alt = 'Contact BeatsChain - Get in Touch'
...
export default async function Image() {
  ...
  try {
    ...
    const page = await client.fetch(`*[_type == "page" && slug.current == "contact"][0] {
      seo
    }`)
    ...
    console.warn('Failed to fetch contact page image:', error)
  }
        ...
        {!featuredImage && (
          ...
          >
            ...
            <p style={{ fontSize: '28px', margin: '0', opacity: 0.9 }}>
              Get in Touch with BeatsChain
            </p>
            <p style={{ fontSize: '24px', margin: '20px 0 0 0', opacity: 0.8 }}>
              💬 Support • 🤝 Partnerships • 🎵 Beat Inquiries
            </p>
          </div>
        )}
      </div>
