...
export const alt = 'BeatsChain FAQ - Frequently Asked Questions'
...
export default async function Image() {
  ...
  try {
    ...
    const page = await client.fetch(`*[_type == "page" && slug.current == "faq"][0] {
      seo
    }`)
    ...
    console.warn('Failed to fetch FAQ page image:', error)
  }
  ...
  return new ImageResponse(
    (
      ...
      >
        {imageBase64 ? (
          <img src={imageBase64} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="FAQ" />
        ) : (
          <div
            style={{
              display: 'flex',
          ...
          >
            ...
            <p style={{ fontSize: '24px', margin: '20px 0 0 0', opacity: 0.8 }}>
              🎵 Beat Buying • 🎫 NFT Ownership • 💰 Royalties
            </p>
          </div>
        )}
      </div>
