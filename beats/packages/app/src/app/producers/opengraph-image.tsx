...
export const alt = 'BeatsChain Producers - Meet Our Beat Makers'
export const size = {
  width: 1200,
  height: 630,
}
...
export default async function Image() {
  ...
  try {
    ...
    const page = await client.fetch(`*[_type == "page" && slug.current == "producers"][0] {
      seo
    }`)
    ...
    console.warn('Failed to fetch producers page image:', error)
  }
        ...
        {!featuredImage && (
          ...
          >
            ...
            <p style={{ fontSize: '28px', margin: '0', opacity: 0.9 }}>
              South Africa's Most Talented Producers
            </p>
            <p style={{ fontSize: '24px', margin: '20px 0 0 0', opacity: 0.8 }}>
              🇿🇦 SA Focus • 🎹 Growing Community • 🚀 Web3 Platform
            </p>
          </div>
        )}
      </div>
